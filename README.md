...
明日序 V1.0.1 静态官网，包含真实界面截图、桌面小部件介绍、APK 直链下载和[版本更新记录](versions.html)。
...
APK 已经在 `downloads/mingrixu-v1.0.1.apk`，部署后首页“下载”按钮就是直链。
...
1. 替换 `downloads/mingrixu-v1.0.1.apk`。
